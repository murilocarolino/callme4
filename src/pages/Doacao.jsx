    ...
    return (
        <div className={styles.doacao}>
            ...
            <h2 className={styles.subtitle}>
                Ajude ONG's de psicologia e pessoas necessitadas! Dê um apoio para nossa plataforma:
            </h2>
                ...
                <div className={styles.homeContent}>
                    <div className={styles.donationOptions}>
                        <div className={styles.donationButtons}>
                            <button
                                className={`${styles.donationButton} ${selectedButton === '1' ? styles.selected : ''}`}
            ...
            {currentPage === "pix" && (
                <div className={styles.pixPage}>
                    <div className={styles.qrContainer}>
                        <img src={imgGallery.qrcode.src} alt="QR Code" />
                        <div className={styles.codeBox}>
                            <input
                                type="text"
                                value="Código Pix Exemplo"
                                readOnly
